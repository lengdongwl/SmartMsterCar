 ...
 * @LastEditTime: 2021-12-17 20:36:39
 */
...
static uint8_t Alarm_Open[6]={0x03,0x05,0x14,0x45,0xDE,0x92};		// 烽火台(警报器) 开启
static uint8_t Alarm_Close[6]={0x67,0x34,0x78,0xA2,0xFD,0x27};		// 烽火台(警报器) 关闭
//立体显示标志物 起始位[0]=0xFF [1]=模式编号 [2][3][4][5]可变数据
...
static uint8_t S_Display[6]={0xFF,0x15,0x00,0x00,0x00,0x00};		// 立体显示标志物 
