 ...
 * @LastEditTime: 2022-10-10 20:41:07
 * @LastEditors: 309 Mushroom
 * @Description: In User Settings Edit
 * @FilePath: \USERc:\Users\lengd\Desktop\单片机\car\testcar\CarV1.0.2\HARDWARE\CAN\canp_hostcom.h
 */
#include "stm32f4xx.h"
...
GLOBAL u16  Get_Host_TrackDieCount( u8 mode);
...
GLOBAL void Send_Debug_string(char *s);
GLOBAL void Send_Debug_string2(char *s);
GLOBAL void Send_Debug_num(unsigned int num);
GLOBAL void Send_Debug_num2(unsigned int num);
...
GLOBAL int16_t CanHost_Mp;//注意码盘值超过范围32768会变负数 
...
GLOBAL void Send_Debug(uint32_t Debug); 
GLOBAL void Send_Debug_HEX(uint32_t Debug); 
